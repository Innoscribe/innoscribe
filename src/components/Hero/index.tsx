            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mt-16 relative">
                  <div className="relative mx-auto max-w-[845px] border-4 border-white rounded-xl overflow-hidden bg-gray-100">
                    <video
                      ref={videoRef}
                    ...
                    <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
                      <button
                        ...
                        className="bg-[#58c0c2] hover:bg-[#4dbabc] text-white p-2 rounded-full transition-colors"
                      >
