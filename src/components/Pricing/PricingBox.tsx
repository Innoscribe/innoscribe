    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      ...
      >
        {product.nickname === "Premium" && (
          <p className="absolute right-[-50px] top-[60px] inline-block -rotate-90 rounded-bl-md rounded-tl-md bg-[#58c0c2] px-5 py-2 text-base font-medium text-white">
